...
<head>
    ...
    <style>
        ...
        .btn-container {
            ...
            padding: 10px;
            box-shadow: 0 2px 4px rgba(0, 0, 0, .1); /* Button container box shadow */
        }
        .btn {
            margin-right: 10px;
        }
        ...
        .sidebar-logo {
            ...
            border-bottom: 1px solid #4a4e69; /* Add a border line below the logo */
        }
        .sidebar-menu {
    ...
    <div class="layout">
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item"><a href="addInstructor.jsp">Add Instructor</a></li> <!-- Updated link -->
                <li class="sidebar-menu-item"><a href="addStudent.jsp">Add Student</a></li>
                <li class="sidebar-menu-item"><a href="addCourse.jsp">Add
						Course</a></li>
                <li class="sidebar-menu-item"><a href="/assignClassForm">Assign Class</a></li>
            </ul>
        ...
        <form action="/assignCourse" method="post">
            <div class="form-group">
                ...
                <select id="studentId" name="instructor_id" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="courseId" name="course_id" class="form-control">
